...
namespace Microsoft.FSharp.Collections
    ...
    module Array = 
        ...
        val indexOfMin: array:'T[] -> int when 'T : comparison
        ...
        val indexOfMax: array:'T[] -> int when 'T : comparison

        /// <summary>Returns the index of the minimum element generated by applying the function to each element of the array. If there are multiple, the first index is returned.</summary>
        /// <param name="projection">The function to transform the array elements before searching.</param>
        /// <param name="array">The input array.</param>
        /// <exception cref="System.ArgumentException">Thrown when <c>array</c> is empty.</exception>
        /// <returns>The index of the minimum element for the projection.</returns>
        /// <exception cref="System.ArgumentNullException">Thrown when the input array is null.</exception>
        [<CompiledName("IndexOfMinBy")>]
        val indexOfMinBy: projection:('T1->'T2) -> array:'T1[] -> int when 'T2 : comparison

        /// <summary>Returns the index of the maximum element generated by applying the function to each element of the array. If there are multiple, the first index is returned.</summary>
        /// <param name="projection">The function to transform the array elements before searching.</param>
        /// <param name="array">The input array.</param>
        /// <exception cref="System.ArgumentException">Thrown when <c>array</c> is empty.</exception>
        ...
        val indexOfMaxBy: projection:('T1->'T2) -> array:'T1[] -> int when 'T2 : comparison
