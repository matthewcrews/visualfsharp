...
namespace Microsoft.FSharp.Collections
    ...
    module List = 
        ...
        /// <summary>Returns the index of the minimum element. If there are multiple minima, it will return the first.</summary>
        /// <param name="list">The input list.</param>
        /// <exception cref="System.ArgumentException">Thrown when <c>list</c> is empty.</exception>
        /// <returns>Returns the index of the first minimal element.</returns>
        [<CompiledName("IndexOfMin")>]
        val indexOfMin: list:'T list -> int when 'T : comparison

        /// <summary>Returns the index of the maximum element. If there are multiple maxima, it will return the first.</summary>
        /// <param name="list">The input list.</param>
        /// <exception cref="System.ArgumentException">Thrown when <c>list</c> is empty.</exception>
        /// <returns>Returns the index of the first maximal element.</returns>
        [<CompiledName("IndexOfMax")>]
        val indexOfMax: list:'T list -> int when 'T : comparison

        /// <summary>Returns the index of the minimum element generated by applying the function to each element of the list. If there are multiple, the first index is returned.</summary>
        /// <param name="projection">The function to transform the list elements before searching.</param>
        /// <param name="list">The input list.</param>
        /// <exception cref="System.ArgumentException">Thrown when <c>list</c> is empty.</exception>
        /// <returns>The index of the minimum element for the projection.</returns>
        [<CompiledName("IndexOfMinBy")>]
        val indexOfMinBy: projection:('T1->'T2) -> list:'T1 list -> int when 'T2 : comparison

        /// <summary>Returns the index of the maximum element generated by applying the function to each element of the list. If there are multiple, the first index is returned.</summary>
        /// <param name="projection">The function to transform the list elements before searching.</param>
        /// <param name="list">The input list.</param>
        /// <exception cref="System.ArgumentException">Thrown when <c>list</c> is empty.</exception>
        /// <returns>The index of the maximum element for the projection.</returns>
        [<CompiledName("IndexOfMaxBy")>]
        val indexOfMaxBy: projection:('T1->'T2) -> list:'T1 list -> int when 'T2 : comparison